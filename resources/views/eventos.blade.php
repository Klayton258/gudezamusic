...
<div class="container-fluid !direction !spacing">
    <div class="page-title">
        <img src="{{asset('assets/components/EVENTOS.png')}}">
    </div>
</div>
...
<div class="container mt-5 d-flex">
    <div class="row content">
        {{-- card-start --}}
        <div class="col-sm-12 col-md-4 col-lg-4 mt-4 d-flex justify-content-center align-items-center">

            <a href="{{ route('eventDetail') }}">
            <div class="shadow overflow">
                <div id="header"
                style="background:url({{asset('images/slide_covers/1659065534.png')}});
                 width:50vw;
                max-width:400px;
                min-width:300px;
                height:150px;
                ...
                transition: all .08s linear;"></div>

                <div id="profile">
                    <div class="image">
                        <img src="{{ asset('images/music_covers/1651518292.jpg') }}" alt="" />
                    </div>
                    <div class="name">
                        Kiss You Stream
                    </div>
                    <div class="nickname">
                        Celeblacao do lancamento da remix kiss you
                    </div>
                    <div class="location">
                        <i class="material-icons">place</i>Kwetu Maputo, Rua da Argelia 414
                    </div>
                    <div class="bottom">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 mt-4 d-flex justify-content-center align-items-center">
            <div class="shadow overflow">
                <div id="header"
                style="background:url(http://i.imgur.com/woUbg3p.jpg);
                 width:50vw;
                max-width:400px;
                min-width:300px;
                height:150px;
