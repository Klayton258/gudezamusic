...
<head>
    ...
    <title>Para Sempre - Acustica</title>
</head>
...
<body onload="carregar()">
    ...
    <div class="container justify-content-center">
        <img src="assets/imgs/capa4.jpg" class="col-lg-4 hmau img-fluid">
        <h3 class="nome">Charles Caló</h3>
        ...
        <div class="col col-lg-4 col-md-4">
            <div class="row">
                ...
                <a class="linka" target="_blank" href="https://soundcloud.com/charlescalo/sets/quem-ama-sofre-ep">
