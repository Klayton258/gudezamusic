...
<body>
    ...
    <div class="container justify-content-center">
        <img src="assets/imgs/novosdesafios-II.png" class="col-lg-4 hmau img-fluid">
        <h3 class="nome">Charles Caló</h3>
        <h2 class="titulo">Novos Desafios II</h2>
        ...
        <div class="col col-lg-4 col-md-4 justify-content-center">
            <div class="row">
                ...
                <a class="linka" target="_blank" href="https://gudezamusic.com/Novos-Desafios-II">
